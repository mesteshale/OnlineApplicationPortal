...
def add_sample_data():
    print('Adding sample data to the ApplicationInformation model...')
    ...
    print('Successfully added sample data to the ApplicationInformation model!')
    print(f'Total ApplicationInformation records: {ApplicationInformation.objects.count()}')
